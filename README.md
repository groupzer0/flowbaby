...
**Status**: v0.3.9 Released - [Download VSIX](https://github.com/groupzer0/flowbaby/releases)  
...
1. Download latest `.vsix` from [GitHub Releases](https://github.com/groupzer0/flowbaby/releases)
