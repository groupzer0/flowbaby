...
from ontology_provider import load_ontology, OntologyLoadError, ontology_to_json_legacy_format
...
class TestOntologyValidation:
    ...
    def test_ontology_entities_are_non_empty_strings(self):
        ...
        for entity in ontology['entities']:
            ...
            assert len(entity) > 0, f"Entity name should not be empty"
    ...
    def test_ontology_relationships_are_non_empty_strings(self):
        ...
        for rel in ontology['relationships']:
            ...
            assert len(rel) > 0, f"Relationship name should not be empty"
